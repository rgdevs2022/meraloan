...
const POSTS = [
  ...
  },
  {
    ...
    categoryColor: "text-[#E53935] bg-red-50",
...
export default function BlogSection() {
  return (
    <section className="py-20 bg-[#F8FAFC]" id="blogs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <a href="#" className="text-[#E53935] font-semibold text-sm flex items-center gap-1 hover:gap-2 transition-all">
            ...
            >
              ...
              <div className={`h-44 bg-gradient-to-br ${post.color} relative overflow-hidden`}>
                ...
                <div className="absolute bottom-4 left-4">
                  <span className="text-white/80 text-xs font-medium">{post.date}</span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <h3 className="font-bold text-gray-900 text-base leading-snug mb-3 group-hover:text-[#E53935] transition-colors line-clamp-2">
                  {post.title}
                </h3>
                ...
                <div className="mt-4 flex items-center text-[#E53935] text-sm font-semibold group-hover:gap-2 gap-1 transition-all">
